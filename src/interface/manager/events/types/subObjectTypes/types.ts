...
export namespace Manager.Events.Type{
    ...
    export abstract class SubObjectTypeAbstract {
      public ChooseAction (_object: ObjectTemplate, _invokeLogic: LogicDelegate) : boolean {
        return ActionType.ActionTypes[_object.ActionEnum].Act(_object, _invokeLogic)
      }
